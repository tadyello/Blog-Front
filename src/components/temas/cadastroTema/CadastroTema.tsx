    ...
    return (
        <Container maxWidth="sm" className="topo">
            <form onSubmit={onSubmit}>
                ...
                <TextField id="select" value={tema.hashtag} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedTema(e)} label='#' variant='outlined' name='hashtag' margin='normal' fullWidth select>
                            <MenuItem value="#BANCODADOS">#BANCODADOS</MenuItem>
